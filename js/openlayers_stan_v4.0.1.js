...
(function(root, factory) {
    ...
    function t(a, b) {
        ...
        for (var e; d.length && (e = d.shift());) d.length || void 0 === b ? c[e] ? c = c[e] : c = c[e] = {} : c[e] = b
    };
    var ba, ca;
    ...
    */
    ...
    function Gb(a) {
        ...
        if (a instanceof yb) b = a;
            ...
            var b = zb[a] || null,
                c = wb || window.proj4;
            b || "function" != typeof c || void 0 === c.defs(a) || (b = new yb({
                code: a
            }), Pb(b))
        }
        return b
    ...
    function ac(a, b) {
        for (var c = a.b.length, d = Array(c), e = a.minZoom; e < c; ++e) d[e] = cc(a, b, e);
        a.a = d
    };
    ...
    function sc(a, b, c, d) {
        for (var e, f = 0, g = a.length; f < g; ++f)
            if (e = a[f], e.listener === b && e.Vg === c) return d && (e.deleteIndex = f), e
    }
    ...
    function vc(a, b) {
        var c = tc(a, b);
        if (c) {
            for (var d = 0, e = c.length; d < e; ++d) a.removeEventListener(b, c[d].Wg), qb(c[d]);
            c.length = 0;
    ...
    Dc.prototype.addEventListener = function(a, b) {
        var c = this.qa[a];
        c || (c = this.qa[a] = []); - 1 === c.indexOf(b) && c.push(b)
    };
    ...
    k.once = function(a, b, c) {
        if (Array.isArray(a)) {
            for (var d = a.length, e = Array(d), f = 0; f < d; ++f) e[f] = wc(this, a[f], b, c);
            return e
        }
    ...
    k.mp = function(a, b) {
        var c = this.ec();
        if (a < c) c = this.a[a], this.a[a] = b, this.b(new Nc("remove", c)), this.b(new Nc("add", b));
        else {
            ...
            if (a.hasOwnProperty(c)) d = a[c];
                ...
                if (Oc.exec(d)) {
                    ...
                    1 == g && (f = (f << 4) + f, e = (e << 4) + e, d = (d << 4) +
                        d);
                    f = [f, e, d, 1]
                } else d.indexOf("rgba(") ? d.indexOf("rgb(") ? qa(!1, 14) : (d = d.slice(4, -1).split(",").map(Number), d.push(1), f = Uc(d)) : (d = d.slice(5, -1).split(",").map(Number), f = Uc(d));
                d = f;
                a[c] = d;
                ++b
            }
    ...
    ad.prototype.setMap = function(a) {
        ...
        this.v.length = 0;
        if (this.a = a)(this.S ? this.S : a.u).appendChild(this.element), this.render !== na && this.v.push(B(a, "postrender", this.render, this)), a.render()
    };
    ...
    function cd(a) {
        if (a = a.frameState) {
            ...
            c = b[0];
            b = b[1];
            for (var Z in this.o) Z in c ? (this.l[Z] || (this.o[Z].style.display = "", this.l[Z] = !0), delete c[Z]) : Z in b ? (this.l[Z] && (this.o[Z].style.display = "none", delete this.l[Z]), delete b[Z]) : (Zc(this.o[Z]), delete this.o[Z], delete this.l[Z]);
            for (Z in c) d = document.createElement("LI"),
                d.innerHTML = c[Z].b, this.R.appendChild(d), this.o[Z] = d, this.l[Z] = !0;
            for (Z in b) d = document.createElement("LI"), d.innerHTML = b[Z].b, d.style.display = "none", this.R.appendChild(d), this.o[Z] = d;
            ...
            for (var Cb in a) b = a[Cb], b instanceof HTMLElement && (this.u.appendChild(b),
                Z[Cb] = b), Cb in Z || (Ra = new Image, Ra.src = Cb, "" === b ? c = Ra : (c = document.createElement("a"), c.href = b, c.appendChild(Ra)), this.u.appendChild(c), Z[Cb] = c);
    ...
    function kd(a) {
        ...
        B(h, "click", kd.prototype.l.bind(this,
            c));
        d = document.createElement("button");
        d.className = b + "-out";
        d.setAttribute("type", "button");
    ...
    var Ed, Fd = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
    ...
    function oe(a, b, c) {
        ...
        var e = Array.prototype.slice.call(b.changedTouches),
            f = e.length,
            g, h;
        for (g = 0; g < f; ++g) h = ne(a, b, e[g]), h.preventDefault = d, c.call(a, b, h)
    }
    k.Dp = function(a) {
        var b = a.touches,
    ...
    function pe(a, b) {
        ...
        if (a.f === d.identifier) {
            ...
            c.push(e);
            setTimeout(function() {
                var a = c.indexOf(e); - 1 < a && c.splice(a, 1)
            }, 2500)
        }
    };
    ...
    function ae(a, b) {
        for (var c = {}, d, e = 0, f = we.length; e < f; e++) d = we[e][0], c[d] = a[d] || b[d] || we[e][1];
        return c
    }
    ...
    re.prototype.ra = function() {
        for (var a = this.a.length, b, c = 0; c < a; c++) b = this.a[c], ve(this, Object.keys(b.i));
    ...
    Fe.prototype.j = function(a) {
        a = a.target;
        var b = a.V();
        if (2 === b || 3 === b || 4 === b || 5 === b) xc(a, "change", this.j, this), a = a.ib(), a in this.g && (delete this.g[a], --this.l), this.v()
    };

    function Ge(a, b, c) {
        for (var d = 0, e, f; a.l < b && d < c && 0 < a.b.length;) e = Be(a)[0], f = e.ib(), 0 !== e.V() || f in a.g || (a.g[f] = !0, ++a.l, ++d, e.load())
    };

    function He(a) {
        return function(b, c, d) {
            if (void 0 !== b) return b = fa(a, b, d), b = wa(b + c, 0, a.length - 1), c = Math.floor(b), b != c && c < a.length - 1 ? a[c] / Math.pow(a[c] / a[c + 1], b - c) : a[c]
        }
    }
                    ...
                    for (; b < r;) {
                        ...
                        if (Pa != n || ra != g) {
                            var La = n - A,
                                ...
                                Ma = Pa - A,
                                xb = ra - V;
                            La * xb == C * Ma && (0 > La && Ma < La || La == Ma || 0 < La && Ma > La) && (0 > C && xb < C || C == xb || 0 <
                                C && xb > C) || (y[z++] = n, y[z++] = g, A = n, V = g);
                            n = Pa;
                            g = ra
                        }
                    }
    ...
    function Gf(a, b, c, d, e) {
        var f = c[0];
        if (!(Ff(a, b, f, d, e) || Bf(a, b, f, d, e[0], e[1]) || Bf(a, b, f, d, e[0], e[3]) || Bf(a, b, f, d, e[2], e[1]) || Bf(a, b, f, d, e[2], e[3]))) return !1;
        if (1 === c.length) return !0;
        b = 1;
        for (f = c.length; b < f; ++b)
            if (Af(a, c[b - 1], c[b], d, e)) return !1;
        return !0
    };
    ...
    function Pf(a, b, c, d) {
        var e = a.ha(),
            ...
            l = e.length / g - 1;
        d = d ? d : 0;
        for (var m, p, n = 0; n <= l; ++n) p = n * g, m = d + 2 * Ca(n, l) * Math.PI / l, e[p] = b[0] + c * Math.cos(m), e[p + 1] = b[1] + c * Math.sin(m);
        a.ca(f, e, h)
    };
    ...
    function Qf(a) {
        ...
        if (void 0 !== a.resolutions) c = a.resolutions, d = c[0], e = c[c.length - 1], c = He(c);
        else {
            d = Qb(a.projection);
            e = d.D();
        ...
        void 0 !== a.resolution ? b.resolution = a.resolution :
            void 0 !== a.zoom && (b.resolution = this.constrainResolution(this.a, a.zoom - this.j));
    ...
    k.Ff = function(a, b) {
        ...
        var m = e.ha(),
            ...
            x = -Infinity;
        e = e.sa();
        for (var y = 0, z = m.length; y < z; y += e) var A = m[y] * n - m[y + 1] * p,
            V = m[y] * p + m[y + 1] * n,
            q = Math.min(q, A),
            r = Math.min(r, V),
            v = Math.max(v, A),
    ...
    function pg(a) {
        a = a ? a : {};
        ag.call(this, {
            handleEvent: a.handleEvent ? a.handleEvent : qg
        });
    ...
    function qg(a) {
        ...
        var b = !1,
            c = a.type;
        if ("pointerdown" === c || "pointerdrag" === c || "pointerup" === c) c = a.b, "pointerup" == a.type ? delete this.Y[c.pointerId] : "pointerdown" == a.type ? this.Y[c.pointerId] = c : c.pointerId in this.Y && (this.Y[c.pointerId] = c), this.l = rb(this.Y);
    ...
    function Og(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.g(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
                ...
                Ve(d, b.Va());
                c = this.l;
                if (e = b.Ba()) d = b.Ec([e[0] + d[0], e[1] + d[1]]), c ? b.animate({
                    duration: c,
                    easing: hd,
                    center: d
                }) : b.wb(d);
    ...
    function ch(a) {
        ...
        (void 0 !== a.dragPan ? a.dragPan : 1) && b.push(new sg({
            kinetic: c
        }));
        (void 0 !== a.pinchRotate ? a.pinchRotate : 1) && b.push(new Vg);
        (void 0 !== a.pinchZoom ? a.pinchZoom : 1) && b.push(new Zg({
            duration: a.zoomDuration
        }));
        if (void 0 !== a.keyboard ? a.keyboard : 1) b.push(new Ng), b.push(new Pg({
            delta: a.zoomDelta,
            duration: a.zoomDuration
        }));
        (void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) && b.push(new Rg({
            duration: a.zoomDuration
        }));
        (void 0 !== a.shiftDragZoom ? a.shiftDragZoom : 1) && b.push(new Mg({
            duration: a.zoomDuration
        }));
        return b
    };
    ...
    k.nl = function() {
        ...
        var a = a.a,
            c, d;
        b = 0;
        for (c = a.length; b < c; b++) d = a[b], this.c[w(d).toString()] = [B(d, "propertychange", this.ze, this), B(d, "change", this.ze, this)];
        this.s()
    };
    k.ml = function(a) {
        a = a.element;
    ...
    k.Lf = function(a) {
        ...
        a = eh(this);
        var d, e;
        for (d = b.length; c < d; c++) e = b[c], e.opacity *= a.opacity, e.visible = e.visible && a.visible, e.maxResolution = Math.min(e.maxResolution, a.maxResolution), e.minResolution = Math.max(e.minResolution, a.minResolution), void 0 !== a.extent && (e.extent = void 0 !== e.extent ? lb(e.extent, a.extent) : a.extent);
        return b
    };
    k.Nf = function() {
        return "ready"
    ...
    function Nb(a, b, c) {
        ...
        c = 1 < c ? c : 2;
        void 0 === b && (2 < c ? b = a.slice() : b = Array(d));
        for (var e = 0; e < d; e += c) b[e] = 180 * a[e] / kh, b[e + 1] = 360 * Math.atan(Math.exp(a[e + 1] / 6378137)) / Math.PI - 90;
        return b
    };
    ...
    function Jh() {
        if (32 < uh.a) {
            var a = 0,
                b, c;
            for (b in uh.b) c = uh.b[b], a++ & 3 || Ec(c) || (delete uh.b[b], --uh.a)
        }
    }
    k.Aa = function(a, b, c, d, e, f, g) {
        ...
        for (q = n.length - 1; 0 <= q; --q) {
            var v = n[q],
                r = v.layer;
            if (sh(v, p) && f.call(g, r) && (v = Kh(this, r), r.la() && (l = v.Aa(r.la().G ? m : a, b, c, h, e)), l)) return l
        }
    };
    ...
    function Vh(a, b) {
        var c = a.f,
            d = a.R;
        d ? d.fillStyle != b.fillStyle && (d.fillStyle = c.fillStyle = b.fillStyle) : (c.fillStyle = b.fillStyle, a.R = {
    ...
    function Wh(a, b) {
        ...
        d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), Ld && !ia(d.lineDash, b.lineDash) && c.setLineDash(d.lineDash = b.lineDash), d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth = c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) : (c.lineCap = b.lineCap, Ld && c.setLineDash(b.lineDash), c.lineJoin = b.lineJoin, c.lineWidth =
            b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.S = {
                lineCap: b.lineCap,
                lineDash: b.lineDash,
                lineJoin: b.lineJoin,
    ...
    ci.prototype.vg = function(a) {
        if (a) {
            ...
            var d = a.viewState.resolution,
                g, h, l, e = 0;
            for (g = f.length; e < g; ++e) l = f[e], h = l.layer, h = Kh(this, h), sh(l, d) && "ready" == l.Ui && h.qd(a, l) && h.I(a, l, b);
            c && b.restore();
    ...
    qi.prototype.i = function(a, b, c, d, e, f, g, h, l, m, p) {
        ...
        this.l && (q = n.isEnabled(n.STENCIL_TEST), r = n.getParameter(n.STENCIL_FUNC), v = n.getParameter(n.STENCIL_VALUE_MASK), x = n.getParameter(n.STENCIL_REF), y = n.getParameter(n.STENCIL_WRITEMASK), z = n.getParameter(n.STENCIL_FAIL), A = n.getParameter(n.STENCIL_PASS_DEPTH_PASS), V = n.getParameter(n.STENCIL_PASS_DEPTH_FAIL), n.enable(n.STENCIL_TEST), n.clear(n.STENCIL_BUFFER_BIT), n.stencilMask(255), n.stencilFunc(n.ALWAYS, 1, 255), n.stencilOp(n.KEEP, n.KEEP,
            n.REPLACE), this.l.i(a, b, c, d, e, f, g, h, l, m, p), n.stencilMask(0), n.stencilFunc(n.NOTEQUAL, 1, 255));
        ri(a, 34962, this.v);
        ri(a, 34963, this.o);
        f = this.ff(n, a, e, f);
        var Pa = xh(this.mb);
        ...
        n.uniform1f(f.a, g);
        var ra;
        l ? (m ? a = this.qe(n, a, h, l, p) : (n.clear(n.COLOR_BUFFER_BIT |
            n.DEPTH_BUFFER_BIT), this.Md(n, a, h, !0), a = (a = l(null)) ? a : void 0), ra = a) : this.Md(n, a, h, !1);
        this.gf(n, f);
    ...
    k.Md = function(a, b, c) {
        if (sb(c)) {
            ...
            for (c = this.u.length - 1; 0 <= c; --c) d = this.u[c], f = this.j[c], a.uniform4fv(this.I.G, f[0]), Di(this, a, f[1], f[2]), si(a, b, d, e), e = d
        } else {
            var g, h, l, m;
            l = this.f.length - 2;
            f = e = this.f[l + 1];
            for (d = this.u.length - 1; 0 <= d; --d) {
                ...
                Di(this, a, g[1], g[2]);
                for (g = this.u[d]; 0 <= l && this.f[l] >= g;) m = this.f[l], h = this.g[l], h = w(h).toString(), c[h] && (e !== f && si(a, b, e, f), f = m), l--, e = m;
                e !== f && si(a, b, e, f);
                e = f = g
            }
        }
    ...
    k.qe = function(a, b, c, d, e) {
        ...
        for (f = this.u.length - 1; 0 <= f; --f)
            for (g = this.j[f], a.uniform4fv(this.I.G, g[0]), Di(this, a, g[1], g[2]), l = this.u[f]; 0 <= n && this.f[n] >= l;) {
                ...
                m = this.g[n];
                p = w(m).toString();
                if (void 0 === c[p] && m.U() && (void 0 === e || mb(e, m.U().D())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), si(a, b, g, h), h = d(m))) return h;
                n--;
                h = g
            }
    };
    ...
    function Qi(a, b, c, d) {
        ...
        for (V = 0; V < c; V += d) C = b[V] - a.origin[0], Ma = b[V + 1] - a.origin[1], Pa = A / 8, ra = -v * e, La = -v * (g - f), a.a[A++] = C, a.a[A++] = Ma, a.a[A++] = ra * y - La * r, a.a[A++] = ra * r + La * y, a.a[A++] = p / l, a.a[A++] = (n + g) / h, a.a[A++] = m, a.a[A++] = q, ra = v * (x - e), La = -v * (g - f), a.a[A++] = C, a.a[A++] = Ma, a.a[A++] = ra * y - La * r, a.a[A++] = ra * r + La * y, a.a[A++] = (p + x) / l, a.a[A++] = (n + g) / h, a.a[A++] =
            m, a.a[A++] = q, ra = v * (x - e), La = v * f, a.a[A++] = C, a.a[A++] = Ma, a.a[A++] = ra * y - La * r, a.a[A++] = ra * r + La * y, a.a[A++] = (p + x) / l, a.a[A++] = n / h, a.a[A++] = m, a.a[A++] = q, ra = -v * e, La = v * f, a.a[A++] = C, a.a[A++] = Ma, a.a[A++] = ra * y - La * r, a.a[A++] = ra * r + La * y, a.a[A++] = p / l, a.a[A++] = n / h, a.a[A++] = m, a.a[A++] = q, a.b[z++] = Pa, a.b[z++] = Pa + 1, a.b[z++] = Pa + 2, a.b[z++] = Pa, a.b[z++] = Pa + 2, a.b[z++] = Pa + 3
    }
    k.oc = function(a, b) {
        this.f.push(this.b.length);
        this.g.push(b);
    ...
    function Ri(a, b, c, d) {
        ...
        for (g = 0; g < h; ++g) e = b[g], f = w(e).toString(), f in c ? e = c[f] : (e = Oi(d, e), c[f] = e), a[g] = e
    }
    k.ff = function(a, b) {
        var c = Ci(b, Fi, Hi),
            d;
    ...
    k.qe = function(a, b, c, d, e) {
        ...
        for (f = this.u.length - 1; 0 <= f; --f)
            for (a.bindTexture(3553, this.u[f]), g = 0 < f ? this.I[f - 1] : 0, l = this.I[f]; 0 <= n && this.f[n] >= g;) {
                ...
                m = this.g[n];
                p = w(m).toString();
                if (void 0 === c[p] && m.U() && (void 0 === e || mb(e, m.U().D())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), si(a, b, h, l), l = d(m))) return l;
                l = h;
                n--
            }
    };
    ...
    function Zi(a, b, c, d) {
        ...
        for (e = 0; e < c; e += d) {
            ...
            if (e)
                if (e === c - d) {
                    m ? z = p : (x = x || [0, 0], f = $i(a, x, y, [0, 0], v * aj * (l || 1), f), f = $i(a, x, y, [0, 0], -v * aj * (l || 1), f), a.b[g++] = q, a.b[g++] = r - 1, a.b[g++] = r, a.b[g++] = r, a.b[g++] = q + 1, a.b[g++] = q, l && (f = $i(a, x, y, [0, 0], v * bj * l, f), f = $i(a, x, y, [0, 0], -v * bj * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q +
    ...
    function jj(a, b, c, d) {
        ...
        if (c.length) {
            var e;
            b = 0;
            for (e = c.length; b < e; ++b) Si(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])), Zi(a, c[b], c[b].length, d)
        }
    }
    ...
    k.Md = function(a, b, c, d) {
        ...
        if (sb(c)) {
            ...
            for (c = this.j.length - 1; 0 <= c; --c) g = this.j[c], l = this.u[c], lj(this, a, l[0], l[1], l[2]), si(a, b, g, h), a.clear(a.DEPTH_BUFFER_BIT), h = g
        } else {
            var m, p, n, q;
            n = this.f.length - 2;
            l = h = this.f[n + 1];
            for (g = this.j.length - 1; 0 <= g; --g) {
                ...
                for (m = this.j[g]; 0 <= n && this.f[n] >= m;) q = this.f[n],
                    p = this.g[n], p = w(p).toString(), c[p] && (h !== l && (si(a, b, h, l), a.clear(a.DEPTH_BUFFER_BIT)), l = q), n--, h = q;
    ...
    k.Na = function(a, b) {
        ...
        var d = b.c,
            ...
            e = b.j,
            e = void 0 !== e ? e : 10;
        this.c.strokeColor && ia(this.c.strokeColor, c) && this.c.lineWidth === d && this.c.miterLimit === e || (this.c.s = !0, this.c.strokeColor = c, this.c.lineWidth = d, this.c.miterLimit =
            e, this.u.push([c, d, e]))
    };
    var dj = 3,
        aj = 5,
            ...
            return function d(a, b, g) {
                ...
                2: [function(a, b) {
                    ...
                    function h(a, b, d, e, f) {
                        ...
                        f.ja = -Infinity;
                        for (var g; b <
                            d; b++) g = a.children[b], l(f, a.hb ? e(g) : g);
                        return f
                    }
                    ...
                    d.prototype = {
                        ...
                        search: function(a) {
                            ...
                            for (var f = [], g, h, l, m; b;) {
                                g = 0;
                                for (h = b.children.length; g < h; g++) l = b.children[g], m = b.hb ? e(l) : l, v(a, m) && (b.hb ? d.push(l) : r(a, m) ? this.Kg(l, d) : f.push(l));
                                b = f.pop()
                            }
                            return d
                        },
                        ...
                        Kg: function(a, b) {
                            for (var d = []; a;) a.hb ? b.push.apply(b, a.children) : d.push.apply(d, a.children), a = d.pop();
                            return b
                        },
                        Mg: function(a, b, d, f) {
                            var g = d - b + 1,
                            ...
                            for (y(a, b, d, h, this.Af); b <= d; b += h)
                                for (n = Math.min(b + h - 1, d), y(a, b, n, g, this.Bf), m = b; m <= n; m += g) p = Math.min(m + g - 1, n), l.children.push(this.Mg(a, m, p, f - 1));
                            e(l, this.yb);
                            return l
                        },
                        Ij: function(a, b, d, e) {
                            for (var f, g, h, l, m, p, q, r;;) {
                                ...
                                q = r = Infinity;
                                f = 0;
                                for (g = b.children.length; f < g; f++) h = b.children[f], m = n(h), p = (Math.max(h.ba, a.ba) - Math.min(h.da, a.da)) * (Math.max(h.ja, a.ja) - Math.min(h.fa, a.fa)) - m, p < r ? (r = p, q = m < q ? m : q, l = h) : p === r && m < q && (q = m, l = h);
                                b = l || b.children[0]
                            }
                            return b
                        },
                        ...
                        Hj: function(a, b, d) {
                            var e, f, g, l, m, p, q;
                            m = p = Infinity;
                            for (e = b; e <= d - b; e++) f = h(a, 0, e, this.yb), g = h(a, e, d, this.yb), l = Math.max(0, Math.min(f.ba, g.ba) - Math.max(f.da, g.da)) * Math.max(0,
                                Math.min(f.ja, g.ja) - Math.max(f.fa, g.fa)), f = n(f) + n(g), l < m ? (m = l, q = e, p = f < p ? f : p) : l === m && f < p && (p = f, q = e);
                            return q
                        },
                        Gj: function(a, b, d) {
                        ...
                        Lg: function(a, b, d, e) {
                            ...
                            var f = h(a, 0, b, e),
                                ...
                                m = q(f) + q(g),
                                p, n;
                            for (p = b; p < d - b; p++) n = a.children[p], l(f, a.hb ? e(n) : n), m += q(f);
                            for (p = d - b - 1; p >= b; p--) n = a.children[p], l(g, a.hb ? e(n) : n), m += q(g);
                            return m
                        },
                        Fj: function(a, b, d) {
                            for (; 0 <= d; d--) l(b[d], a)
                        ...
                        Jj: function(a) {
                            for (var b = a.length - 1, d; 0 <= b; b--) 0 === a[b].children.length ? 0 < b ? (d = a[b - 1].children, d.splice(d.indexOf(a[b]), 1)) : this.clear() : e(a[b], this.yb)
                        },
                        Lj: function(a) {
                            var b = ["return a", " - b", ";"];
    ...
    function Mj(a, b, c, d, e, f) {
        ...
        if (f === Hf(b, 0, b.length, c))
            for (p = m = Qj(a, b[0], b[1], l++), f = b[0], g = c, h = b.length; g < h; g += c) n = Qj(a, b[g], b[g + 1], l++), r.push(Rj(p, n, d)), q.push([Math.min(p.x, n.x), Math.min(p.y, n.y), Math.max(p.x, n.x), Math.max(p.y, n.y)]), f = b[g] > f ? b[g] : f, p = n;
        else
            for (g = b.length - c, p = m = Qj(a, b[g], b[g + 1], l++), f = b[g], g -= c, h = 0; g >= h; g -= c) n = Qj(a, b[g], b[g + 1], l++), r.push(Rj(p, n, d)), q.push([Math.min(p.x, n.x), Math.min(p.y, n.y), Math.max(p.x, n.x), Math.max(p.y, n.y)]), f = b[g] > f ? b[g] :
                f, p = n;
        r.push(Rj(n, m, d));
        ...
        for (var d = !1, e = Wj(b, c); 3 < b.c;)
            ...
            if (e = Wj(b, c)) {
                var d = b,
                    ...
                    l = h,
                    m = 0;
                do g[m++] = l.aa.x, g[m++] = l.aa.y, l = vj(d); while (l !== h);
                d = !Hf(g, 0, f, 2);
                Oj(b, c, d)
            } else {
                e = a;
                ...
                do {
                    ...
                    if (h.length) {
                        ...
                        for (f = vj(d); f !== g;) Rj(f.aa, f.W, l, m), c.remove(f), tj(d), f = zj(d);
                        Rj(g.aa, h, l, m);
                        g.aa = h;
    ...
    function Vj(a, b, c, d, e) {
        ...
        for (f = m.length; d < f; ++d)
            for (g in m[d]) h = m[d][g], "object" !== typeof h || e && !h.vb || h.x === a.x && h.y === a.y || h.x === b.x && h.y === b.y || h.x === c.x && h.y === c.y || -1 !== l.indexOf(h) || !Bf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, h.x, h.y) || l.push(h);
        return l
    }
    ...
    function Uj(a, b, c, d, e) {
        ...
        if (f && (d = ((d.x - c.x) * (a.y - c.y) - (d.y - c.y) * (a.x - c.x)) / f, c = ((b.x - a.x) * (a.y - c.y) - (b.y - a.y) * (a.x - c.x)) / f, !e && d > xi && d < 1 - xi && c > xi && c < 1 - xi || e && 0 <= d && 1 >= d && 0 <= c && 1 >= c)) return [a.x + d * (b.x - a.x), a.y + d * (b.y - a.y)]
    }
        ...
        for (h = c.length; g < h; ++g) {
            ...
            if (0 < p.length) {
                var n = p[0].ha(),
                    ...
                    r;
                l = 1;
                for (m = p.length; l < m; ++l) r = p[l].ha(), r = ef(r, r.length, d, -this.origin[0], -this.origin[1]), q.push(r);
                jj(this.l, n, q, d);
                Lj(this, n, q, d)
            }
        }
    ...
    k.rc = function(a, b) {
        ...
        if (0 < c.length) {
            ...
            var e = c[0].ha(),
                ...
                g, h, l;
            g = 1;
            for (h = c.length; g < h; ++g) l = c[g].ha(), l = ef(l, l.length, d, -this.origin[0], -this.origin[1]), f.push(l);
            jj(this.l, e, f, d);
            Lj(this, e, f, d)
        }
    };
    ...
    k.Md = function(a, b, c, d) {
        ...
        if (sb(c)) {
            var g, h, l;
            h = this.f[this.f.length - 1];
            for (c = this.c.length - 1; 0 <= c; --c) g = this.c[c], l = this.u[c], a.uniform4fv(this.I.G, l), si(a, b, g, h), h = g
        } else {
            var m, p, n, q;
            n = this.f.length - 2;
            l = h = this.f[n + 1];
            for (g = this.c.length - 1; 0 <= g; --g) {
                ...
                for (m = this.c[g]; 0 <= n && this.f[n] >= m;) q = this.f[n], p = this.g[n], p = w(p).toString(),
                    c[p] && (h !== l && (si(a, b, h, l), a.clear(a.DEPTH_BUFFER_BIT)), l = q), n--, h = q;
                h !== l && (si(a, b, h, l), a.clear(a.DEPTH_BUFFER_BIT));
                h = l = m
            }
        }
    ...
    bk.prototype.i = function(a, b, c, d, e, f, g, h) {
        ...
        for (p = l.length; m < p; ++m)
            for (r = this.a[l[m].toString()], n = 0, q = ei.length; n < q; ++n) v = r[ei[n]], void 0 !== v && v.i(a, b, c, d, e, f, g, h, void 0, !1)
    };
    ...
    function fk(a, b, c, d, e, f, g, h, l, m, p) {
        ...
        for (v = q.length; r < v; ++r)
            for (y = a.a[q[r].toString()], x = ei.length - 1; 0 <= x; --x)
                if (z = y[ei[x]], void 0 !== z && (z = z.i(b, c, d, e, n, f, g, h, l, m, p))) return z
    }
    ...
    function lk(a, b, c, d) {
        var e = a.f,
            f = b.ib();
        if (a.a.b.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Fb), 9729 != a.Bh && (e.texParameteri(3553, 10240, 9729), a.Bh = 9729), 9729 != a.Dh && (e.texParameteri(3553, 10241, 9729), a.Dh = 9729);
        else {
    ...
    k.vg = function(a) {
        ...
        var f = a.viewState.resolution,
            g, h, l, m;
        g = 0;
        for (h = e.length; g < h; ++g) m = e[g], sh(m, f) && "ready" == m.Ui && (l = Kh(this, m.layer), l.ag(a, m, b) && d.push(m));
        ...
        g = 0;
        for (h = d.length; g < h; ++g) m = d[g], l = Kh(this, m.layer), l.ai(a, m, b);
    ...
    k.Aa = function(a, b, c, d, e, f, g) {
        ...
        for (p = m.length - 1; 0 <= p; --p) {
            h = m[p];
            var n = h.layer;
            if (sh(h, l.resolution) && f.call(g, n) && (h = Kh(this, n).Aa(a, b, c, d, e))) return h
        }
    };
    k.Zh = function(a, b, c, d, e) {
        c = !1;
        ...
        for (h = g.length - 1; 0 <= h; --h) {
            var l = g[h],
                m = l.layer;
            if (sh(l, f.resolution) && d.call(e, m) && (c = Kh(this, m).Ke(a, b))) return !0
        }
        return c
    };
    k.Yh = function(a, b, c, d, e) {
        ...
        for (l = h.length - 1; 0 <= l; --l) {
            g = h[l];
            var m = g.layer;
            if (sh(g, f.resolution) && e.call(d, m) && (g = Kh(this, m).Zf(a, b, c, d))) return g
        }
    };
    var ok = ["canvas", "webgl"];
    ...
    k.re = function(a, b, c) {
        if (this.a) return a = this.Za(a), c = c ? c : {}, this.C.Aa(a, this.a, void 0 !== c.hitTolerance ? c.hitTolerance * this.a.pixelRatio : 0, b, null, c.layerFilter ? c.layerFilter : af, null)
    };
    k.pm = function(a, b, c, d, e) {
        if (this.a) return this.C.Yh(a, this.a, b, void 0 !== c ? c : null, d ? d : af, void 0 !== e ? e : null)
    };
    k.El = function(a, b) {
        if (!this.a) return !1;
        var c = this.Za(a);
    ...
    function pk(a) {
        ...
        e = a.layers instanceof fh ? a.layers : new fh({
            layers: a.layers
        });
        c.layergroup = e;
        c.target = a.target;
        ...
        if (this.get(uk) && this.autoPan) {
            ...
            if (a && a.Kc()) {
                var b = xk(a.Kc(), a.Mb()),
                    ...
                    g = xk(c, [d, e]),
                    c = this.j;
                Ta(b, g) || (d = g[0] - b[0], e = b[2] - g[2], f = g[1] - b[1], g = b[3] - g[3], b = [0, 0], 0 > d ? b[0] = d - c : 0 > e && (b[0] = Math.abs(e) + c), 0 > f ? b[1] = f - c : 0 > g && (b[1] =
    ...
    function wk(a) {
        ...
        if (b && b.a && c) {
            var c = b.Ka(c),
                ...
                g = e[0],
                e = e[1];
            if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Ce && (a.a.Ce = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.bf != g && (a.a.bf = b.right = g);
            else {
    ...
    function Ck(a) {
        ...
        if (b.a && c.a) {
            var d = b.Mb(),
                ...
                f = db(h),
                l;
            if (a = a.a.$().Ba()) l = [e[0] - a[0], e[1] - a[1]], Ve(l, c), Qe(l, a);
            b.Wf(l);
    ...
    function Xk(a, b) {
        ...
        void 0 === b ? (e = Xc(m, m), a.I = e.canvas, c = m = a.I.width, a.ah(d, e, 0, 0), a.Wa ? a.A = a.I : (e = Xc(d.size, d.size), a.A = e.canvas, a.$g(d, e, 0, 0))) : (m = Math.round(m), (e = !a.Wa) && (c = a.$g.bind(a, d)), a.Ya ? (f = a.Ya, void 0 ===
            ...
            a.i[5] && a.b == a.i[6] || (a.i = ["r" + f + g + (void 0 !== a.a ? a.a.toString() : "-") + (void 0 !== a.f ? a.f.toString() : "-") + (void 0 !== a.j ? a.j.toString() : "-") + (void 0 !== a.b ? a.b.toString() : "-"), f, g, a.a, a.f, a.j, a.b]), d = b.add(a.i[0], m, m, a.ah.bind(a, d), c), a.I = d.image, a.qa = [d.offsetX, d.offsetY], c = d.image.width, a.A = e ? d.Fl : a.I);
        a.C = [m / 2, m / 2];
        a.ta = [m, m];
        a.G = [c, c]
    }
    k.ah = function(a, b, c, d) {
        ...
        if (Infinity === this.b) b.arc(a.size / 2, a.size / 2, this.a, 0, 2 * Math.PI, !0);
            ...
            for (this.f !== this.a && (this.b *= 2), c = 0; c <= this.b; c++) d = 2 * c * Math.PI / this.b - Math.PI / 2 + this.j, e = c % 2 ? this.f : this.a, b.lineTo(a.size / 2 + e * Math.cos(d), a.size / 2 + e * Math.sin(d));
        this.Wa && (b.fillStyle = Vc(this.Wa.b), b.fill());
        this.Ya && (b.strokeStyle = a.strokeStyle, b.lineWidth = a.Vi, a.lineDash && b.setLineDash(a.lineDash), b.lineCap = a.lineCap, b.lineJoin = a.lineJoin,
    ...
    k.$g = function(a, b, c, d) {
        ...
        if (Infinity === this.b) b.arc(a.size / 2, a.size / 2, this.a, 0, 2 * Math.PI, !0);
            ...
            var e;
            for (c = 0; c <= this.b; c++) e = 2 * c * Math.PI / this.b - Math.PI / 2 + this.j, d = c % 2 ? this.f : this.a, b.lineTo(a.size / 2 + d * Math.cos(e), a.size / 2 + d * Math.sin(e))
        }
        b.fillStyle = Nh;
        b.fill();
    ...
    function kl(a, b, c) {
        if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE) b ? c.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(a.nodeValue);
            ...
            for (a = a.firstChild; a; a = a.nextSibling) kl(a, b, c);
        return c
    }
    ...
    function Il(a, b, c, d, e, f) {
        ...
        if (1 === l) g = a[b], h = a[b + 1];
            ...
            l = 0;
            m = g.length;
            for (p = !1; l < m;) e = l + (m - l >> 1), h = +da(g[e], c), 0 > h ? l = e + 1 : (m = e, p = !h);
            e = p ? l : ~l;
    ...
    k.Jm = function() {
        var a = this.B,
            ...
            e = 0,
            f;
        for (f = 0 + b; f < this.B.length; f += b) var g = a[f],
            h = a[f + 1],
    ...
    k.pa = function(a, b) {
        if (a) {
            ...
            var c = this.B,
                ...
                h, l;
            h = 0;
            for (l = a.length; h < l; ++h) f = tf(c, f, a[h], d, e[g]), e[g++] = f, f = f[f.length - 1];
            e.length = g;
    ...
    function Pl(a, b) {
        ...
        if ("number" === typeof a.x && "number" === typeof a.y) c = "Point";
            ...
            var h, l;
            h = 0;
            for (l = d.length; h < l; ++h) f.length = 0, sf(f, 0, d[h], e.length), Hf(f, 0, f.length, e.length) ? g.push([d[h]]) : c.push(d[h]);
            for (; c.length;) {
                d = c.shift();
                e = !1;
                for (h = g.length - 1; 0 <= h; h--)
    ...
    k.Qd = function(a) {
        ...
        if (e) return a = new qm(null), tm(a), a.a = c, rm(a), a.s(), this.i[b] = a;
        this.g = a;
        return this
    };
    k.T = function() {
    ...
    function Bm(a, b, c) {
        var d = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ga(d, a.yc(b, c));
        return d
    }
    k.Tc = function(a, b) {
        if (ll(a)) return null;
    ...
    k.Xd = function(a, b) {
        ...
        if ("FeatureCollection" == c) "http://www.opengis.net/wfs" === a.namespaceURI ? d = L([], this.b, a, b, this) : d = L(null, this.b, a, b, this);
            ...
            for (v in g) {
                p = {};
                h = 0;
                for (l = f.length; h < l; ++h)(-1 === f[h].indexOf(":") ? "p0" : f[h].split(":")[0]) === v && (p[f[h].split(":").pop()] = "featureMembers" == c ? ql(this.ig, this) : rl(this.ig, this));
                e[g[v]] = p
            }
    ...
    k.Mo = function(a, b) {
        for (var c = jl(a, !1), d = /^\s*([+\-]?\d*\.?\d+(?:[eE][+\-]?\d+)?)\s*/, e = [], f; f = d.exec(c);) e.push(parseFloat(f[1])), c = c.substr(f[0].length);
        if ("" === c) {
            c = b[0].srsName;
            d = "enu";
            c && (d = Gb(c).b);
    ...
    k.Cj = {
        "http://www.opengis.net/gml": {
            patches: rl(Pm.prototype.To)
        }
    };
    k.nj = {
        "http://www.opengis.net/gml": {
            segments: rl(Pm.prototype.Wo)
        }
    };
    k.oj = {
        "http://www.opengis.net/gml": {
    ...
    k.vj = {
        "http://www.opengis.net/gml": {
            PolygonPatch: rl(Pm.prototype.Uo)
        }
    };
    k.Aj = {
        "http://www.opengis.net/gml": {
            LineStringSegment: rl(Pm.prototype.Oo)
        }
    };
    ...
    k.Jp = function(a, b, c) {
        ...
        zl({
            node: a
        }, Rm, wl, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
    };
    k.ej = function(a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
    ...
    k.fe = {
        "http://www.opengis.net/gml": {
            coordinates: rl(Ym.prototype.ui)
        }
    };
    k.qf = {
        "http://www.opengis.net/gml": {
    ...
    k.lj = {
        "http://www.opengis.net/gml": {
            coordinates: ql(Ym.prototype.ui)
        }
    };
    k.Jg = {
        "http://www.opengis.net/gml": {
    ...
    function bn(a, b, c) {
        ...
        if (4 !== e) {
            ...
            if (c)
                for (f = 0, g = c.length; f < g; f++) c[f] = c[f] / 4 * e
        }
        return d
    }
    ...
    function sn(a, b, c) {
        ...
        zl({
            node: a
        }, tn, wl, [b.linkText, b.linkType], c, un)
    }
    ...
    var Hn = K($m, {
        rte: J(function(a, b, c) {
            ...
            if (b = b.U()) b = Fl(b, !0, d), a.geometryLayout = b.ka, e.rtept = b.X();
        ...
        wpt: J(function(a, b, c) {
            var d = c[0],
                e = c[c.length - 1];
            e.properties = b.N();
            if (b = b.U()) b = Fl(b, !0, d), e.geometryLayout = b.ka, vn(a, b.X(),
                c)
        })
    });
    ...
    k.Wd = function(a, b) {
        ...
        for (n = d.length; p < n; ++p) {
            ...
            } else "H" == q.charAt(0) && ((r = Nn.exec(q)) ? (l = parseInt(r[1], 10), h = parseInt(r[2], 10) - 1, g = 2E3 + parseInt(r[3], 10)) : (r = Mn.exec(q)) && (e[r[1]] = r[2].trim()))
        }
    ...
    function Sn(a) {
        ...
        this.Wa = void 0 !== a.fill ? a.fill : new Zk({
            color: "#333"
        });
        this.Ya = void 0 !== a.stroke ? a.stroke : null;
    ...
    function Tn(a) {
        a = a ? a : {};
        zm.call(this);
        Un || (Vn = [255, 255, 255, 1], Wn = new Zk({
            color: Vn
        }), Xn = [20, 2], Yn = Zn = "pixels", $n = [64, 64], ao = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", bo = .5, co = new Rn({
            anchor: Xn,
    ...
    function Bo(a, b) {
        ...
        if (e)
            if ("Point" == f) {
                ...
                d.ca(e, f);
                Do(d, c)
            } else "LineString" == f ? (d = new N(null), Ll(d, c), Do(d, c)) : "Polygon" == f ? (d = new P(null), Nl(d, c), Do(d, c)) : "GeometryCollection" == f ? d = new qm(c) : qa(!1, 37);
        else d = new qm(c);
        return d
    }
    ...
    k.yc = function(a, b) {
        ...
        var c;
        c = a.localName;
        if ("Document" == c || "Folder" == c) return (c = this.hg(a, [Dl(this, a, b)])) ? c : [];
    ...
    function ep(a, b) {
        ...
        for (c = b.firstElementChild; c; c = c.nextElementSibling) {
            var d = c.localName;
            if (ea(ko, c.namespaceURI) && ("Document" == d || "Folder" == d || "Placemark" == d || "kml" == d) && (d = ep(a, c))) return d
        }
    }
    k.So = function(a) {
        var b = [];
    ...
    function fp(a, b) {
        var c, d = [];
        for (c = b.firstChild; c; c = c.nextSibling) c.nodeType == Node.ELEMENT_NODE && ga(d, gp(a, c));
        return d
    }
    ...
    function gp(a, b) {
        ...
        for (c = b.firstElementChild; c; c = c.nextElementSibling) e = c.localName, !ea(ko, c.namespaceURI) || "Document" != e && "Folder" != e && "kml" != e || ga(d, gp(a, c));
        return d
    }
    k.Vo = function(a) {
        var b = [];
    ...
    function hp(a, b) {
        var c, d = [];
        for (c = b.firstChild; c; c = c.nextSibling) c.nodeType == Node.ELEMENT_NODE && ga(d, a.$e(c));
        return d
    }
    k.$e = function(a) {
        var b, c = [];
        ...
        for (b = a.firstElementChild; b; b = b.nextElementSibling) a = b.localName, !ea(ko, b.namespaceURI) || "Document" != a && "Folder" != a && "kml" != a || ga(c, this.$e(b));
        return c
    };
    ...
    function sp(a, b, c) {
        ...
        if (f = b.Nc())
            if (f = f.call(b, 0)) f = Array.isArray(f) ? f[0] : f, this.l && (a.Style = f), (f = f.Pa()) && (a.name = f.Pa());
    ...
    var Ep = K(ko, ["Document", "Placemark"]),
        ...
        tp = K(ko, {
            ExtendedData: J(function(a, b, c) {
                ...
                var d = b.names;
                b = b.values;
                for (var e = d.length, f = 0; f < e; f++) zl(a, Ip, Tp, [{
                    name: d[f],
                    value: b[f]
                }], c)
            }),
        ...
        (function(c) {
            ...
            return function d(a, b, g) {
                ...
                4: [function(a, b) {
                    ...
                    d.prototype.Ah = function() {
                        ...
                        for (var b = a.Ma() + a.ga, d = 1, e = 0, f = 0, g = 0, v = [], x; a.ga < b;)
                            if (e || (e = a.Ma(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.Yd(), g += a.Yd(), 1 === d && (x && v.push(x), x = []), x.push(new h(f, g));
                    ...
                    d.prototype.bbox = function() {
                        var a = this.Cc;
                        a.ga = this.tf;
                        for (var b = a.Ma() + a.ga, d = 1, e = 0, f = 0, g = 0, h = Infinity, x = -Infinity, y = Infinity, z = -Infinity; a.ga <
                            b;)
                            if (e || (e = a.Ma(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.Yd(), g += a.Yd(), f < h && (h = f), f > x && (x = f), g < y && (y = g), g > z && (z = g);
                ...
                5: [function(a, b) {
                    ...
                    function e(a, b, d) {
                        15 === a ? b.version = d.Ma() : 1 === a ? b.name = d.sg() : 5 === a ? b.extent = d.Ma() : 2 === a ? b.he.push(d.ga) : 3 === a ? b.ie.push(d.sg()) :
                            4 === a && b.ke.push(h(d))
                    }

                    function h(a) {
                        for (var b = null, d = a.Ma() + a.ga; a.ga < d;) b = a.Ma() >> 3, b = 1 === b ? a.sg() : 2 === b ? a.No() : 3 === b ? a.Jo() : 4 === b ? a.Zo() : 5 === b ? a.Ma() : 6 === b ? a.Yd() : 7 === b ? a.Ho() : null;
                        return b
                    }
                    var l = a("./vectortilefeature.js");
                    b.ma = d;
                    d.prototype.feature = function(a) {
                        if (0 > a || a >= this.he.length) throw Error("feature index out of bounds");
        ...
        fq = K(cq, {
            ...
            way: function(a, b) {
                for (var c = b[0], d = a.getAttribute("id"), e = L({
                        md: [],
                        ae: {}
                    }, dq, a, b), f = b[b.length - 1], g = [], h = 0, l = e.md.length; h < l; h++) ga(g, f.Eh[e.md[h]]);
            ...
            if (c) {
                ...
                for (l = f.length; h < l; ++h) {
                    var m, p, n, q = f[h],
                        ...
                        y = 0;
                    p = 0;
                    for (m = q.length; p < m; ++p) n = q[p], x += n[0], y += n[1], n[0] = x, n[1] = y, Kq(n, r, v)
                }
            }
            c = [];
            g = rb(a.objects);
            h = 0;
            for (l = g.length; h < l; ++h) "GeometryCollection" === g[h].type ? (m = g[h], c.push.apply(c, Hq(m, f, d, e, b))) : (m = g[h], c.push(Iq(m, f, d, e, b)));
            return c
        }
        return []
    };
    ...
    var Jq = {
        ...
        MultiPoint: function(a, b, c) {
            ...
            var d, e;
            if (b && c)
                for (d = 0, e = a.length; d < e; ++d) Kq(a[d], b, c);
            return new O(a)
        },
    ...
    var Qq = {
        "http://www.opengis.net/gml": {
            boundedBy: I(Cm.prototype.We, "bounds")
        }
    };
    ...
    var Wq = {
        "http://www.opengis.net/wfs": {
            ...
            Property: J(function(a, b, c) {
                ...
                a.appendChild(d);
                Mm(d, b.name);
                void 0 !== b.value && null !== b.value && (d = il("http://www.opengis.net/wfs",
                    "Value"), a.appendChild(d), b.value instanceof cf ? Pm.prototype.zd(d, b.value, c) : Mm(d, b.value))
            }),
    ...
    var Yq = {
        "http://www.opengis.net/wfs": {
            Query: J(function(a, b, c) {
                ...
                if (d = d.filter) g = il("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), zl({
                    node: g
                }, Yq, ul(d.Bc), [d], c)
            })
        },
    ...
    k.lg = function(a, b) {
        ...
        for (var e = [], f = 0, g = c.length; f < g; ++f) d = new H, d.Sa(c[f]), e.push(d);
        return e
    };
    k.ud = function(a, b) {
        var c;
    ...
    var Wr = [null, "http://www.opengis.net/wmts/1.0"],
        ...
        bs = K(Wr, {
            TileMatrixSet: I(Q),
            TileMatrixSetLimits: I(function(a,
                b) {
                return L([], es, a, b)
            })
        }),
    ...
    k.Gb = function(a, b, c, d) {
        ...
        if (b < d) {
            if (b)
                for (d = this.Vd() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2; d < this.a; ++d) c[d] = e[d];
            else
    ...
    function ks(a, b, c) {
        for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f, e], m = [h, g], p = [1, 0], n = {}, q = 1E5, r, v, x, y, z; 0 < --q && 0 < p.length;) x = p.pop(), e = l.pop(), g = m.pop(), f = x.toString(), f in n || (d.push(g[0], g[1]), n[f] = !0), y = p.pop(), f = l.pop(), h = m.pop(), z = (x + y) / 2, r = a(z), v = b(r), za(v[0], v[1], g[0], g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), f = y.toString(), n[f] = !0) : (p.push(y, z, z, x), m.push(h, v, v, g), l.push(f, r, r, e));
        return d
    }
    ...
    k.wh = function(a) {
        ...
        if (-1 == g) this.b.length = this.a.length = 0;
            ...
            for (h = 0; n != this.c && h++ < f;) n = Math.max(n - g, this.c), l = qs(this, n, q, m, a, d, l);
            n = wa(e, this.c, this.f);
            for (h = 0; n != this.f && h++ < f;) n = Math.min(n + g, this.f), l = qs(this, n, q, m, a, d, l);
            this.b.length = l;
            c = Math.floor(c / g) * g;
            e = wa(c, this.l, this.g);
            l = rs(this, e, a, d, 0);
            for (h = 0; e != this.l && h++ < f;) e = Math.max(e - g, this.l), l = rs(this, e, a, d, l);
            e = wa(c, this.l, this.g);
            for (h = 0; e != this.g && h++ < f;) e = Math.min(e + g, this.g), l = rs(this, e, a, d, l);
            this.a.length = l
        }
        b.Na(null, this.ta);
        a = 0;
    ...
    k.load = function() {
        if (0 == this.state || 3 == this.state) this.state = 1, this.s(), this.f = [wc(this.M, "error", this.mm, this), wc(this.M, "load", this.nm, this)], this.g(this, this.l)
    };
    k.zg = function(a) {
        this.M = a
    };
    ...
    k.load = function() {
        if (0 == this.state || 3 == this.state) this.state = 1, this.s(), this.c = [wc(this.M, "error", this.km, this), wc(this.M, "load", this.lm, this)], this.j(this, this.g)
    };
    ...
    function Js(a, b, c, d, e, f, g) {
        ...
        var m = [NaN, NaN],
            p = !0,
            n, q, r;
        for (n = c + e; n < d; n += e) m[0] = b[n], m[1] = b[n + 1], r = Ua(l, m), r !== q ? (p && (a.coordinates[h++] = g[0], a.coordinates[h++] = g[1]), a.coordinates[h++] = m[0], a.coordinates[h++] = m[1], p = !1) : 1 === r ? (a.coordinates[h++] = m[0], a.coordinates[h++] = m[1], p = !1) : p = !0, g[0] = m[0], g[1] = m[1], q = r;
            ...
            switch (C[0]) {
                ...
                case 5:
                    ...
                    for ((Ra = C[10]) && (A += e); q < r; q += 2) {
                        C = m[q] + Cb;
                        Ra = m[q + 1] + dc;
                        if (1 != V || A) Fh(v, C, Ra, V, V, A, -C, -Ra), b.setTransform.apply(b, v);
                        $c = Z.split("\n");
                        $d = $c.length;
                        1 < $d ? (Je = Math.round(1.5 * b.measureText("M").width), Ra -= ($d - 1) / 2 * Je) : Je = 0;
                        for (ue = 0; ue < $d; ue++) Tc = $c[ue], xb && b.strokeText(Tc,
                            C, Ra), Ma && b.fillText(Tc, C, Ra), Ra += Je;
                        (1 != V || A) && b.setTransform.apply(b, x)
                    }++p;
                    break;
                case 6:
                ...
                case 8:
                    ...
                    for (q += 2; q < r; q += 2)
                        if (C = m[q], Ra = m[q + 1], A = C + .5 | 0, V = Ra + .5 | 0, q == r - 2 || A !== y || V !== z) b.lineTo(C, Ra), y = A, z = V;
                    ++p;
                    break;
                case 9:
                    a.$a = C[2];
        ...
        if ("" !== this.Fa && this.l && (this.f || this.g)) {
            if (this.f) {
                ...
                if (!g || g.fillStyle != e.fillStyle) {
                    ...
                    this.a.push(h);
                    this.b.push(h);
                    g ? g.fillStyle = e.fillStyle : this.A = {
    ...
    Vs.prototype.Tb = function(a) {
        if (a) {
            var b = a.Ca();
            b ? (b = b.b, b = Vc(b ? b : Nh), this.f ? this.f.fillStyle = b : this.f = {
                fillStyle: b
            }) : this.f = null;
            var c = a.Da();
            if (c) {
    ...
    function Zs(a) {
        ...
        for (var b = a, e = d = 0; b >= d;) Ys(c, a + b, a + d), Ys(c, a + d, a + b), Ys(c, a - d, a + b), Ys(c, a - b, a + d), Ys(c, a - b, a - d), Ys(c, a - d, a - b), Ys(c, a + d, a - b), Ys(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e - b) + 1 && (--b, e += 1 - 2 * b);
        return Xs[a] = c
    }
    ...
    Ws.prototype.i = function(a, b, c, d, e, f) {
        ...
        var l, m, p, n, q, h = 0;
        for (l = g.length; h < l; ++h)
            for (n = this.a[g[h].toString()], m = 0, p = f.length; m < p; ++m) q = n[f[m]], void 0 !== q && q.i(a, b, c, d, e);
        a.restore()
    };
    ...
    function at(a, b, c, d, e, f, g) {
        ...
        for (m = h.length; l < m; ++l)
            for (n = a.a[h[l].toString()], p = ei.length - 1; 0 <= p; --p)
                if (q = n[ei[p]], void 0 !== q && (q = Ls(q, b, 1, c, d, e, q.b, f, g))) return q
    }
    var ct = {
        Circle: Ss,
        Image: Os,
    ...
    function lt(a, b, c, d, e, f, g, h, l, m) {
        ...
        for (A = g; A >= q; --A)
            for (v = cc(c, f, A, v), x = c.La(A), y = v.da; y <= v.ba; ++y)
                for (z = v.fa; z <= v.ja; ++z) g - A <= h ? (r = b.Lc(A, y, z, d, e), 0 == r.V() && (n[r.ib()] = !0, r.ib() in a.a || a.i([r, p, ic(c, r.Ga), x])), l && l.call(m, r)) : b.Eg(A, y, z, e)
    };
    ...
    function st(a, b, c, d, e, f) {
        var g = !1,
            h, l;
        if (h = c.Z()) l = h.Oe(), 2 == l || 3 == l ? h.Yi(e, f) : (0 == l && h.load(), h.zh(e, f), g = !0);
    ...
    var tt = {
        Point: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), a.xc(b.ha(), 0, 2, 2, b, d)
        },
        LineString: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), a.xc(Zh(b), 0, 2, 2, b, d)
        },
        Polygon: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), a.xc(Lf(b),
                0, 2, 2, b, d)
        },
        MultiPoint: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), c = b.ha(), a.xc(c, 0, c.length, b.sa(), b, d)
        },
        MultiLineString: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), c = $h(b), a.xc(c, 0, c.length, 2, b, d)
        },
        MultiPolygon: function(a, b, c, d) {
            ...
            if (e =
                c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), c = bi(b), a.xc(c, 0, c.length, 2, b, d)
        },
        ...
        Circle: function(a, b, c, d) {
            ...
            if (e = c.Pa()) a = a.b(c.za(), "Text"), a.Tb(e), a.xc(b.Ba(), 0, 2, 2, b, d)
        }
    };
    ...
    ut.prototype.I = function(a, b, c) {
        ...
        if ((n = this.i) && !n.f()) {
            ...
            n.i(x, e, p, g, f);
            if (m.G && h.a && !Ta(l, d)) {
                for (var h = d[0], m = hb(l), V = 0; h < l[0];) --V, p = m * V, p = pt(this, a, p), n.i(x, e, p, g, f), h += m;
                V = 0;
                for (h = d[2]; h > l[2];) ++V, p = m * V, p = pt(this, a, p), n.i(x, e, p, g, f), h -= m;
                p = pt(this, a, 0)
            }
            Qh(x, g, z / 2, A / 2);
    ...
    ut.prototype.qd = function(a) {
        function b(a) {
            ...
            if (b) {
                if (b) {
                    d = !1;
                    if (Array.isArray(b))
                        for (var e = 0, f = b.length; e < f; ++e) d = st(q, a, b[e], rt(m, p), this.A, this) || d;
        ...
        if (!this.c && this.o == m && this.u == f && this.j == g && Ta(this.l, l)) return !0;
        this.i = null;
        this.c = !1;
    ...
    k.ag = function(a, b, c) {
        function d(a) {
            ...
            if (b) {
                if (b) {
                    c = !1;
                    if (Array.isArray(b))
                        for (var d = b.length - 1; 0 <= d; --d) c = st(q, a, b[d], rt(m, p), this.bi, this) || c;
        ...
        void 0 === l && (l = qt);
        g = Ka(g, n * m);
        if (!this.o && this.R == m && this.S == h && this.G == l && Ta(this.A, g)) return !0;
    ...
    function Ht(a) {
        if ("string" === typeof a) return [new nc({
            html: a
        })];
    ...
    function Jt(a, b) {
        var c, d, e, f, g = [],
            ...
            l = [];
        d = 0;
        for (e = b.length; d < e; d++) f = b[d], c = w(f).toString(), Lt(a, c, f) && h.push(f);
        d = 0;
    ...
    function Qt(a) {
        ...
        this.rf = a.freehand ? af : a.freehandCondition ? a.freehandCondition :
            lg;
    ...
    function au(a, b) {
        ...
        a.g === Wt ? a.a = c.slice() : a.g === Vt ? (a.a = [
            [c.slice(), c.slice()]
        ], a.R = a.a[0]) : (a.a = [c.slice(), c.slice()], a.g === bu && (a.R = a.a));
    ...
    function nu(a, b, c) {
        ...
        if (f) {
            ...
            var f = f[0],
                g = Re(e, f),
                h = c.Ka(g);
            if (10 >= Ye(b, h)) return b = c.Ka(f[0]), c = c.Ka(f[1]), b = Xe(h, b), c = Xe(h, c), a.C = 10 >= Math.sqrt(Math.min(b, c)), a.C && (g = b > c ? f[1] : f[0]), g
        }
        return null
    }
    ...
    k.Um = function(a, b) {
        ...
        for (m = c.length; l < m; ++l)
            for (p = c[l], g = 0, h = p.length; g < h; ++g)
                for (d = p[g], e = 0, f = d.length - 1; e < f; ++e) n = d.slice(e, e + 2), q = {
                    feature: a,
                    geometry: b,
                    depth: [g, l],
                    index: e,
    ...
    function uu(a) {
        ...
        if (b) {
            ...
            for (var f = 0, g = d.length; f < g; ++f) {
                ...
                p && (m += "-" + p.join("-"));
                e[m] || (e[m] = Array(2));
                if ("Circle" === h.geometry.T() && 1 === h.index) l = Gu(b, h), Ue(l, b) && !e[m][0] && (this.j.push([h, 0]), e[m][0] = h);
                else if (Ue(l[0], b) && !e[m][0]) this.j.push([h, 0]), e[m][0] = h;
                else if (Ue(l[1], b) && !e[m][1]) {
                    if ("LineString" !== h.geometry.T() &&
                        "MultiLineString" !== h.geometry.T() || !e[m][0] || 0 !== e[m][0].index) this.j.push([h, 1]), e[m][1] = h
    ...
    function vu(a) {
        ...
        for (var b = 0, c = this.j.length; b < c; ++b) {
            for (var d = this.j[b], e = d[0], f = e.depth, g = e.geometry, h, l = e.na, d = d[1]; a.length < g.sa();) a.push(l[d][a.length]);
            switch (g.T()) {
                case "Point":
                    h = a;
                    l[0] = l[1] = a;
            ...
            if (p <= a.ia) {
                ...
                if ("Circle" === g.geometry.T() && 1 === g.index) a.oa = !0, Eu(a, l);
                    ...
                    for (p = c.Ka(h[0]), g = c.Ka(h[1]), c = Xe(m, p), m = Xe(m, g), p = Math.sqrt(Math.min(c, m)), a.oa = p <= a.ia, a.oa && (l = c > m ? h[1] : h[0]), Eu(a, l), m = 1, c = f.length; m < c; ++m)
                        if (l = f[m].na, Ue(h[0], l[0]) && Ue(h[1], l[1]) || Ue(h[0], l[1]) && Ue(h[1], l[0])) b[w(l)] = !0;
                        else break;
                b[w(h)] = !0;
                a.Ha = b;
                return
    ...
    k.Il = function(a, b) {
        for (var c = a.na, d = a.feature, e = a.geometry, f = a.depth, g = a.index, h; b.length < e.sa();) b.push(0);
        switch (e.T()) {
            case "MultiLineString":
                h = e.X();
    ...
    k.Ci = function() {
        if (this.S && "pointerdrag" != this.S.type) {
            ...
            var b = this.j,
                c = {},
                d, e, f, g, h, l, m, p, n;
            for (h = b.length - 1; 0 <= h; --h) g = b[h], p = g[0], n = w(p.feature), p.depth && (n += "-" + p.depth.join("-")), n in c || (c[n] = {}), 0 === g[1] ? (c[n].right = p, c[n].index = p.index) : 1 == g[1] && (c[n].left = p, c[n].index = p.index + 1);
            for (n in c) {
                m = c[n].right;
                h = c[n].left;
                g = c[n].index;
    ...
    function Ku(a) {
        ...
        if (e) {
            ...
            f.re(a.pixel, function(a, e) {
                if (this.j(a, e)) {
                    if (!b && !d || ea(g.a, a))(c || d) && ea(g.a, a) && (h.push(a),
                        f = w(a), delete this.a[f]);
                    else {
                        l.push(a);
                        var f = w(a);
                        this.a[f] = e
    ...
    function Pu(a) {
        ...
        if (0 < g.length) {
            ...
            g = g[0].na;
            if (this.ia && !this.R) {
                if (e = b.Ka(g[0]), h = b.Ka(g[1]), e = Xe(d, e), d = Xe(d, h), h = Math.sqrt(Math.min(e, d)), h = h <= this.g) f = !0, l = e > d ? g[1] : g[0], c = b.Ka(l)
            } else this.R && (l = Re(e, g), c = b.Ka(l), Ye(d, c) <= this.g && (f = !0, this.ia && (e = b.Ka(g[0]), h = b.Ka(g[1]), e = Xe(c, e), d = Xe(c, h), h = Math.sqrt(Math.min(e,
                d)), h = h <= this.g))) && (l = e > d ? g[1] : g[0], c = b.Ka(l));
    ...
    k.hl = function() {
        for (var a = this.mh(), b = Xc(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f = a.length; e < f; ++e) c.addColorStop(e * d, a[e]);
        b.fillStyle = c;
    ...
    k.yl = function(a) {
        ...
        for (e = c.length; d < e; d += 4)
            if (f = 4 * c[d + 3]) c[d] = this.l[f], c[d + 1] = this.l[f + 1], c[d + 2] = this.l[f + 2];
        a.putImageData(b, 0, 0)
    };
    k.Ei = function(a) {
        this.set(av, a)
        ...
        h.c.forEach(function(a) {
            ...
            a: {
                ...
                for (l = 0; l < h; l++) {
                    ...
                    g[l] = Cb;
                    for (m = l + 1; m < h; m++)
                        for (Cb = -g[m][l] / g[l][l], dc = l; dc < h + 1; dc++) g[m][dc] = l == dc ? 0 : g[m][dc] + Cb * g[l][dc]
                }
                l = Array(h);
                for (m = h - 1; 0 <= m; m--)
                    for (l[m] = g[m][h] / g[m][m], Cb = m - 1; 0 <= Cb; Cb--) g[Cb][h] -= g[Cb][m] * l[m];g = l
            }
    ...
    function iv(a, b, c, d, e, f, g, h, l, m) {
        ...
        if (v || !a.g || mb(p, a.g)) {
            ...
            if (0 < m && (v || (p = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2]), q = r ? (Ca(f[0], q) + Ca(h[0], q)) / 2 - Ca(p[0], q) : (f[0] + h[0]) / 2 - p[0], p = (f[1] + h[1]) / 2 - p[1],
                    v = q * q + p * p > a.v), v)) {
    ...
    lv.prototype.Z = function(a, b, c, d) {
        ...
        if (e && d && !Tb(e, d)) {
            if (this.a) {
                if (this.ea == this.f && Tb(this.a.v, d) && this.a.resolution == b && this.a.a == c && Za(this.a.D(), a)) return this.a;
                Ac(this.a);
                this.a = null
            }
    ...
    sv.prototype.Ic = function(a, b, c, d) {
        b = mv(this, b);
        var e = this.S;
        if (e && this.Y == this.f && e.resolution == b && e.a == c && Ta(e.D(), a)) return e;
        a = a.slice();
        nb(a, this.oa);
        ...
        this.i.ac(a, function(a) {
            ...
            if (!(d = g)) {
                ...
                if (e) {
                    ...
                    Array.isArray(e) || (e = [e]);
                    d = 0;
                    for (h = e.length; d < h; ++d) n = st(f, a, e[d], rt(b, c), this.En, this) || n;
                    d = n
                } else d = !1
            }
            g = d
        ...
        if (this.M && this.M.Z())
            if (this.a.la() instanceof tv) {
                ...
                if (!(0 > a[0] || a[0] > e[0] || 0 > a[1] || a[1] > e[1]) && (this.i ||
                        (this.i = Xc(1, 1)), this.i.clearRect(0, 0, 1, 1), this.i.drawImage(this.M.Z(), a[0], a[1], 1, 1, 0, 0, 1, 1), e = this.i.getImageData(0, 0, 1, 1).data, 0 < e[3])) return c.call(d, this.a, e)
            }
    };
    ...
    zv.prototype.qd = function(a, b) {
        ...
        for (Ma = x.da; Ma <=
            x.ba; ++Ma)
            for (xb = x.fa; xb <= x.ja; ++xb) C = l.Lc(n, Ma, xb, c, f), Av(this, C) || (C = ws(C)), Av(this, C) ? 2 == C.V() && (A[n][C.Ga.toString()] = C, La || -1 != this.c.indexOf(C) || (La = !0)) : ec(p, C.Ga, V, ra, Pa) || (C = fc(p, C.Ga, ra, Pa)) && V(n + 1, C);
        V = a.viewHints;
        if (!(this.i && 16 < Date.now() - a.time && (V[0] || V[1]) || !La && this.l && Ta(this.l, v) && this.af == m) || r != this.R) {
            ...
            xb = La.canvas;
            V = l.Mf(f);
            xb.width != Ma || xb.height != C ? (this.R = r, xb.width = Ma, xb.height =
                C) : (La.clearRect(0, 0, Ma, C), r = this.R);
            this.c.length = 0;
            ...
            for (dc = ra.length; Cb < dc; ++Cb) {
                ...
                $c = z * l.Jf(f);
                $d = A[Ma];
                for (var Tc in $d) C = $d[Tc], xb = p.Ta(C.Ga, Pa), Ma = (xb[0] - y[0]) / q * z / r, xb = (y[3] - xb[3]) / q * z / r, Je = Ra[0] * Z / r, ue = Ra[1] * Z / r, V || La.clearRect(Ma, xb, Je, ue), this.Df(C, a, b, Ma, xb, Je, ue, $c), this.c.push(C)
            }
            this.af = m;
            this.i = q * c / z * r;
            this.l = y
        ...
        Tc = this.i / g;
        Tc = Fh(this.C, c * d[0] / 2, c * d[1] / 2, Tc, Tc, 0, (this.l[0] -
            e[0]) / this.i * c, (e[1] - this.l[3]) / this.i * c);
        ...
        if (this.j && ua(this.j, A) && this.o == l.f) v = this.A;
            ...
            for (Ra = A.da; Ra <= A.ba; ++Ra)
                for (Cb = A.fa; Cb <= A.ja; ++Cb) {
                    ra = l.Lc(p, Ra, Cb, r, g);
                    if (void 0 !== b.extent && (Z = m.Ta(ra.Ga, La), !mb(Z, b.extent))) continue;
                    Z = ra.V();
            ...
            for (var C = new Float32Array(4), dc, Ma = 0, xb = b.length; Ma < xb; ++Ma)
                for (dc in Ra = c[b[Ma]], Ra) ra = Ra[dc], Z = m.Ta(ra.Ga, La), C[0] = 2 * (Z[2] - Z[0]) / V, C[1] = 2 * (Z[3] - Z[1]) / V, C[2] = 2 * (Z[0] - v[0]) / V - 1, C[3] = 2 * (Z[1] - v[1]) / V - 1, e.uniform4fv(this.i.c, C), lk(d,
                    ra, q, x * r), e.drawArrays(5, 0, 4);
    ...
    function Lv(a, b, c) {
        function d(a) {
            ...
            if (b) {
                ...
                if (b) {
                    var f = !1;
                    if (Array.isArray(b))
                        for (var g = 0, h = b.length; g < h; ++g) f = st(d, a, b[g], c, this.$h, this) || f;
        ...
        if (l.Ld || l.af != g || l.wg != h) {
            ...
            var m = e.la(),
                ...
                v, x, y;
            "tile-pixels" ==
            q.Jb() ? (v = y = m.pb(), p = Ga(p.fb(n[0])), v = [0, 0, p[0] * v, p[1] * v]) : (y = r, v = p.Ta(n), Tb(c, q) || (x = !0, b.Xf(c)));
            l.Ld = !1;
    ...
    k.Aa = function(a, b, c, d, e) {
        ...
        var g = this.a,
            ...
            n, q, r, v, x, y;
        r = 0;
        for (v = l.length; r < v; ++r) y = l[r], q = y.Ga, x = m.tileGrid.Ta(q, this.j), Qa(Ka(x, c * f), a) && ("tile-pixels" === y.l.Jb() ? (x = eb(x), f = m.pb(), q = p.La(q[0]) / f, q = [(a[0] - x[0]) / q, (x[1] - a[1]) / q]) : q = a, y = y.f.vd, n = n || y.Aa(q, f, b, c, {}, function(a) {
            var b = w(a).toString();
    ...
    k.Ue = function(a, b, c) {
        ...
        if (d)
            for (var e = b.pixelRatio, f = b.viewState.rotation, g = b.size, h = Math.round(e * g[0] / 2), g = Math.round(e * g[1] / 2), l = this.c, m = [], p = [], n = l.length - 1; 0 <= n; --n) {
                ...
                Qh(a, -f, h, g);
                A = 0;
                for (V = m.length; A < V; ++A) y = m[A], v < p[A] && (a.beginPath(), a.moveTo(x[0], x[1]), a.lineTo(x[2], x[3]), a.lineTo(x[4], x[5]), a.lineTo(x[6], x[7]), a.moveTo(y[6], y[7]), a.lineTo(y[4], y[5]), a.lineTo(y[2], y[3]), a.lineTo(y[0], y[1]), a.clip());
                q.f.vd.i(a, e, r, f, {}, d);
                a.restore();
                m.push(x);
                p.push(v)
    ...
    function Pv(a, b, c, d, e, f, g, h, l, m, p) {
        ...
        f = h ? lb(f, h) : f;
        if (fb(f))
            if ((h = a.D()) && (e ? e = lb(e, h) : e = h), d = ev(a, c, jb(f), d.La(this.o[0])), !isFinite(d) || 0 >= d) this.state = 4;
            ...
            if (this.g = b.Mc(d), c = jv(this.v), e && (a.a ? (c[1] = wa(c[1], e[1], e[3]), c[3] = wa(c[3], e[1], e[3])) : c = lb(c, e)), fb(c)) {
                a =
                    cc(b, c, this.g);
                for (b = a.da; b <= a.ba; b++)
                    for (c = a.fa; c <= a.ja; c++)(m = l(this.g, b, c, g)) && this.f.push(m);
            ...
            this.f.forEach(function(b) {
                ...
                if (0 == c || 1 == c) {
                    ...
                    d = B(b, "change", function() {
                        var c = b.V();
                        if (2 == c || 3 == c || 4 == c) rc(d), a--, a || (this.wd.forEach(rc), this.wd = null, this.Zd())
                    }, this);
                    this.wd.push(d)
                }
            }, this);
    ...
    function et(a, b, c, d, e) {
        ...
        for (var f = !0, g, h, l = d.da; l <= d.ba; ++l)
            for (var m = d.fa; m <= d.ja; ++m) g = a.Sb(c, l, m), h = !1, b.b.hasOwnProperty(g) && (g = b.get(g), (h = 2 === g.V()) && (h = !1 !== e(g))), h || (f = !1);
        return f
    }
    k.Jf = function() {
        return 0
    ...
    function ew(a) {
        ...
        this.i = a.key;
        this.o = a.imagerySet;
        Ov("https://dev.virtualearth.net/REST/v1/Imagery/Metadata/" + this.o + "?uriScheme=https&include=ImageryProviders&key=" +
            this.i, this.ia.bind(this), void 0, "jsonp")
    }
    u(ew, W);
    var fw = new nc({
    ...
    ew.prototype.ia = function(a) {
        if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) It(this, "error");
        else {
            ...
            this.tileUrlFunction = Sv(c.imageUrlSubdomains.map(function(a) {
                ...
                return function(a) {
                    if (a) return Yb(a[0], a[1], -a[2] - 1, b), a = d, g && (a += "&dpi=d1&device=mobile"), a.replace("{quadkey}", Zb(b))
                }
            }));
            if (c.imageryProviders) {
                ...
                a = c.imageryProviders.map(function(a) {
                    ...
                    a.coverageAreas.forEach(function(a) {
                        ...
                        var g, l;
                        for (g = b; g <= f; ++g) l = g.toString(), b = cc(e, a, g), l in c ? c[l].push(b) : c[l] = [b]
                    });
                    return new nc({
                        html: b,
                        tileRanges: c
    ...
    k.Ic = function(a, b, c, d) {
        ...
        c = this.Y ? c : 1;
        var e = this.M;
        if (e && this.C == this.f && e.resolution == b && e.a == c && Ta(e.D(), a)) return e;
        e = {
            F: "image",
            FORMAT: "PNG32",
            TRANSPARENT: !0
    ...
    k.Ic = function(a, b, c) {
        ...
        c = this.Y ? c : 1;
        var d = this.M;
        if (d && this.A == this.f && d.resolution == b && d.a == c && Ta(d.D(), a)) return d;
    ...
    k.Ic = function(a, b, c, d) {
        ...
        if ((f = this.M) && this.S == this.f && f.resolution == b && f.a == c && Ta(f.D(), g)) return f;
        g = {
            SERVICE: "WMS",
            VERSION: "1.3.0",
            REQUEST: "GetMap",
            ...
            return function d(a, b, g) {
                ...
                2: [function(a, b) {
                    ...
                    function l(a) {
                        this.uf = !!a.Gl;
                        var b;
                        0 === a.threads ? b = 0 : this.uf ? b = 1 : b = a.threads ||
                            1;
                        var d = [];
                        if (b)
                            for (var f = 0; f < b; ++f) d[f] = e(a, this.Qg.bind(this, f));
                    ...
                    l.prototype.Kj = function(a) {
                        for (this.Cd.push(a); this.Cd.length > this.Mj;) this.Cd.shift().fd(null, null)
                    };
                        ...
                        if (0 === this.je && 0 < this.Cd.length) {
                            ...
                            if (1 === f) this.le[0].postMessage({
                                ...
                                for (var g = 4 * Math.ceil(a.inputs[0].data.length / 4 / f), h = 0; h < f; ++h) {
                                    for (var l = h * g, m = [], V = 0, Pa = e.length; V < Pa; ++V) m.push(e[h].slice(l, l + g));
                    ...
                    l.prototype.Nj = function() {
                        var a =
                            ...
                            b = this.le.length,
                            d, e;
                        if (1 === b) d = new Uint8ClampedArray(this.cd[0].buffer), e = this.cd[0].meta;
                        else {
    ...
    function ww(a) {
        ...
        this.i = xw(a.sources);
        for (var b = 0, c = this.i.length; b < c; ++b) B(this.i[b], "change", this.s, this);
        this.g = Xc();
        this.ia = new Fe(function() {
            return 1
        }, this.s.bind(this));
        for (var b = yw(this.i), c = {}, d = 0, e = b.length; d < e; ++d) c[w(b[d].layer)] = b[d];
        this.o = this.v = null;
        this.Y = {
            animate: !1,
            attributions: {},
    ...
    function xw(a) {
        for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
            var e = d,
                f = a[d],
                g = null;
            f instanceof Xv ? (f = new Hv({
                source: f
            }), g = new zv(f)) : f instanceof lv && (f = new yv({
                source: f
            }), g = new dv(f));
            c[e] = g
        }
    ...
    Iw.prototype.Fc = function(a, b, c) {
        ...
        if (!(d.b.length <= a[0])) {
            ...
            pb(d, this.i);
            var g = this.urls;
            g ? (c = c.nb.split(":").pop(), d.SIZE = f[0] + "," + f[1], d.BBOX = e.join(","), d.BBOXSR = c, d.IMAGESR = c, d.DPI = Math.round(d.DPI ? d.DPI * b : 90 * b), a = (1 == g.length ? g[0] : g[Ca((a[1] << a[0]) + a[2], g.length)]).replace(/MapServer\/?$/, "MapServer/export").replace(/ImageServer\/?$/, "ImageServer/exportImage"),
                a = mw(a, d)) : a = void 0;
            return a
        }
    };
    ...
    function Vw(a, b, c, d, e, f, g) {
        ...
        if (h) {
            ...
            g.BBOX = d.join(",");
            return mw(1 == h.length ? h[0] : h[Ca((b[1] <<
                b[0]) + b[2], h.length)], g)
        }
    }
    k.pb = function(a) {
    ...
    t("ol.Observable.unByKey", function(a) {
        if (Array.isArray(a))
            for (var b = 0, c = a.length; b < c; ++b) rc(a[b]);
        else rc(a)
    });
    ...
    t("ol.source.WMTS.optionsFromCapabilities", function(a, b) {
        ...
        var m = ha(a.Contents.TileMatrixSet, function(a) {
            ...
            p;
        p = "projection" in b ? Gb(b.projection) : Gb(m.SupportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,
            "$1:$3"));
